...
import com.our.network.Api.DroidApp;
 ...
 * application
 */
public class NetWorkMainActivity extends Activity implements OnCheckedChangeListener,
		OnClickListener {
	...
	private void setPassword(String pwd) {
		...
		Toast.makeText(NetWorkMainActivity.this, msg, Toast.LENGTH_SHORT).show();
	}
	...
	private void showOrLoadApplications() {
		...
		if (Api.applications == null) {
			...
			new Thread() {
				@Override
				public void run() {
					Api.getApps(NetWorkMainActivity.this);
		...
		final ListAdapter adapter = new ArrayAdapter<DroidApp>(this,
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					...
					entry.box_wifi
							.setOnCheckedChangeListener(NetWorkMainActivity.this);
					entry.box_3g.setOnCheckedChangeListener(NetWorkMainActivity.this);
				} else {
	...
	private void showRules() {
		...
		final Handler handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (!Api.hasRootAccess(NetWorkMainActivity.this, true))
					return;
				Api.showIptablesRules(NetWorkMainActivity.this);
			}
		};
	...
	private void showLog() {
		...
		final Handler handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				Api.showLog(NetWorkMainActivity.this);
			}
		};
		handler.sendEmptyMessageDelayed(0, 100);
	}
	...
	private void clearLog() {
		...
		final Handler handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (!Api.hasRootAccess(NetWorkMainActivity.this, true))
					return;
				if (Api.clearLog(NetWorkMainActivity.this)) {
					Toast.makeText(NetWorkMainActivity.this, R.string.log_cleared,
							Toast.LENGTH_SHORT).show();
				}
			}
		};
		...
		final Handler handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (enabled) {
					...
					if (Api.hasRootAccess(NetWorkMainActivity.this, true)
							&& Api.applyIptablesRules(NetWorkMainActivity.this, true)) {
						Toast.makeText(NetWorkMainActivity.this,
								R.string.rules_applied, Toast.LENGTH_SHORT)
								.show();
					} else {
						Log.d("DroidWall", "Failed - Disabling firewall.");
						Api.setEnabled(NetWorkMainActivity.this, false);
					}
				} else {
					Log.d("DroidWall", "Saving rules.");
					Api.saveRules(NetWorkMainActivity.this);
					Toast.makeText(NetWorkMainActivity.this, R.string.rules_saved,
							Toast.LENGTH_SHORT).show();
				}
			}
		};
	...
	private void purgeRules() {
		...
		final Handler handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (!Api.hasRootAccess(NetWorkMainActivity.this, true))
					return;
				if (Api.purgeIptables(NetWorkMainActivity.this, true)) {
					Toast.makeText(NetWorkMainActivity.this, R.string.rules_deleted,
							Toast.LENGTH_SHORT).show();
				}
			}
		};
